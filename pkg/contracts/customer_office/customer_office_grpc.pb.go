...
const (
	OfficeService_CreateOffice_FullMethodName  = "/mediasoft.internship.final.task.contracts.customer.OfficeService/CreateOffice"
	OfficeService_GetOfficeList_FullMethodName = "/mediasoft.internship.final.task.contracts.customer.OfficeService/GetOfficeList"
)
...
var OfficeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mediasoft.internship.final.task.contracts.customer.OfficeService",
