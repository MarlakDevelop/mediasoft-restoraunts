...
// Validate checks the field values on GetRecordingMenuRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetRecordingMenuRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetRecordingMenuRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetRecordingMenuRequestMultiError, or nil if none found.
func (m *GetRecordingMenuRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetRecordingMenuRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetRecordingMenuRequestMultiError(errors)
	}

	return nil
}

// GetRecordingMenuRequestMultiError is an error wrapping multiple validation
// errors returned by GetRecordingMenuRequest.ValidateAll() if the designated
// constraints aren't met.
type GetRecordingMenuRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetRecordingMenuRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetRecordingMenuRequestMultiError) AllErrors() []error { return m }

// GetRecordingMenuRequestValidationError is the validation error returned by
// GetRecordingMenuRequest.Validate if the designated constraints aren't met.
type GetRecordingMenuRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetRecordingMenuRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetRecordingMenuRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetRecordingMenuRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetRecordingMenuRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetRecordingMenuRequestValidationError) ErrorName() string {
	return "GetRecordingMenuRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetRecordingMenuRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetRecordingMenuRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetRecordingMenuRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetRecordingMenuRequestValidationError{}

// Validate checks the field values on GetRecordingMenuResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetRecordingMenuResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetRecordingMenuResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetRecordingMenuResponseMultiError, or nil if none found.
func (m *GetRecordingMenuResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *GetRecordingMenuResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, GetRecordingMenuResponseValidationError{
					field:  "Menu",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return GetRecordingMenuResponseValidationError{
				field:  "Menu",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return GetRecordingMenuResponseMultiError(errors)
	}

	return nil
}

// GetRecordingMenuResponseMultiError is an error wrapping multiple validation
// errors returned by GetRecordingMenuResponse.ValidateAll() if the designated
// constraints aren't met.
type GetRecordingMenuResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetRecordingMenuResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetRecordingMenuResponseMultiError) AllErrors() []error { return m }

// GetRecordingMenuResponseValidationError is the validation error returned by
// GetRecordingMenuResponse.Validate if the designated constraints aren't met.
type GetRecordingMenuResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetRecordingMenuResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetRecordingMenuResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetRecordingMenuResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetRecordingMenuResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetRecordingMenuResponseValidationError) ErrorName() string {
	return "GetRecordingMenuResponseValidationError"
}

// Error satisfies the builtin error interface
func (e GetRecordingMenuResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetRecordingMenuResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetRecordingMenuResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetRecordingMenuResponseValidationError{}
