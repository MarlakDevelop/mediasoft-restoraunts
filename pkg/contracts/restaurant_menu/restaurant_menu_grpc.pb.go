...
const (
	MenuService_CreateMenu_FullMethodName       = "/mediasoft.internship.final.task.contracts.restaurant.MenuService/CreateMenu"
	MenuService_GetMenu_FullMethodName          = "/mediasoft.internship.final.task.contracts.restaurant.MenuService/GetMenu"
	MenuService_GetRecordingMenu_FullMethodName = "/mediasoft.internship.final.task.contracts.restaurant.MenuService/GetRecordingMenu"
)
...
type MenuServiceClient interface {
	...
	GetRecordingMenu(ctx context.Context, in *GetRecordingMenuRequest, opts ...grpc.CallOption) (*GetRecordingMenuResponse, error)
}
...
func (c *menuServiceClient) GetRecordingMenu(ctx context.Context, in *GetRecordingMenuRequest, opts ...grpc.CallOption) (*GetRecordingMenuResponse, error) {
	out := new(GetRecordingMenuResponse)
	err := c.cc.Invoke(ctx, MenuService_GetRecordingMenu_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MenuServiceServer interface {
	...
	GetRecordingMenu(context.Context, *GetRecordingMenuRequest) (*GetRecordingMenuResponse, error)
}
...
func (UnimplementedMenuServiceServer) GetRecordingMenu(context.Context, *GetRecordingMenuRequest) (*GetRecordingMenuResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRecordingMenu not implemented")
}
...
func _MenuService_GetRecordingMenu_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRecordingMenuRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MenuServiceServer).GetRecordingMenu(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MenuService_GetRecordingMenu_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MenuServiceServer).GetRecordingMenu(ctx, req.(*GetRecordingMenuRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MenuService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mediasoft.internship.final.task.contracts.restaurant.MenuService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetRecordingMenu",
			Handler:    _MenuService_GetRecordingMenu_Handler,
		},
	},
